...
# Multi Cores
* R2 requests that the benchmark done on multiple cores. We perform grouped imputation on the first 8 chromosomes of the EPICv2 GSE286313 data using 4/8 cores (1/2 iterations) in parallel.
...
EPICv2 <- subset(ilmn_manifest("EPICv2", dedupped = FALSE), group != "0")

group_df <- group_features(beta_matrix, EPICv2)

qs2::qs_save(beta_matrix, here("GSE286313", "GSE286313.EPICv2.chr1-8.qs2"))
qs2::qs_save(group_df, here("GSE286313", "GSE286313.EPICv2.chr1-8.group_df.qs2"))
```
...
MSA_manifest <- arrow::read_parquet(get_manifest_obj("MSA"))
